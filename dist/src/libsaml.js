    ...
    return {
        ...
        */
        verifyMessageSignature: function (metadata, octetString, signature, verifyAlgorithm) {
            ...
            try {
                for (var signCert_1 = __values(signCert), signCert_1_1 = signCert_1.next(); !signCert_1_1.done; signCert_1_1 = signCert_1.next()) {
                    var _cert = signCert_1_1.value;
                    var signingScheme = getSigningScheme(verifyAlgorithm);
                    var key = new node_rsa_1.default(utility_1.default.getPublicKeyPemFromCertificate(_cert), 'public', { signingScheme: signingScheme });
                ...
                try {
                    if (signCert_1_1 && !signCert_1_1.done && (_a = signCert_1.return)) _a.call(signCert_1);
                }
